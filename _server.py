...
- LOMLOE: Principio de inclusion como eje transversal. Atencion a la diversidad como derecho de todo el alumnado.
- DUA (Diseno Universal para el Aprendizaje): Multiples formas de representacion, expresion e implicacion.
...
Si un profesor pregunta sobre diversidad, adaptar actividades o perfiles especificos, responde con estrategias PRACTICAS y CONCRETAS para su aula. Recuerda que tienen el generador de Adaptaciones Curriculares en la pestana Hoy.
